      ...
      {isLoading ? (
        <div className="d-flex gap-3">
          <div className="spinner-border spinner-border-sm" role="status">
            <span className="visually-hidden">Loading room information...</span>
          </div>
        ...
        <div className="col-md-6 mt-4 mb-5 shadow p-5 bg-body-tertiary rounded">
          ...
          <p className="fw-semibold">Room Type: {bookingInfo.room.roomType}</p>
          ...
          <p className="fw-semibold">Full Name: {bookingInfo.guestFullName}</p>
          <p className="fw-semibold">Email Address: {bookingInfo.guestEmail}</p>
